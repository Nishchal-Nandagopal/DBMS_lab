...
/*add a new text book to the database and make this book be adopted by some department*/
insert into text_book values(7,"database basics","princeton","shawn");
insert into book_adoption values(11,4,7);

/*a list of text books in the alphabetical order for courses offered by the ‘CS’ department that use more than two books.*/
